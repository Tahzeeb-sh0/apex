...
export default function QuickFactsBand() {
  return (
    <section className="w-full flex justify-center py-5 bg-[#F8F8F8]">
      {/* MAIN CONTAINER */}
      <div className="w-full max-w-[1030px] flex flex-col gap-[30px]">
        ...
        >
          ...
          <div className="flex items-center gap-3 w-[48%] sm:w-auto">
            <span className="font-inter font-bold text-[20px] sm:text-[24px] text-gray-300">
              1
            </span>
            <div>
              <p className="font-montserrat font-bold text-[14px] sm:text-[16px] text-[#505050]">
                Status
              </p>
              <p className="font-montserrat font-bold text-[14px] sm:text-[16px] text-[#3C2B98]">
                In Progress
              </p>
            </div>
          </div>
