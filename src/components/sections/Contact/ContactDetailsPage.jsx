...
export default function ContactDetailsPage() {
  ...
  const validate = () => {
    ...
    if (!form.type.trim())
      newErrors.type = "Please select a requirement type";
  ...
  return (
    <section className="relative w-full -mt-[30px] flex justify-center bg-[#F4F4F4] py-[50px] px-4">
      <div className="w-full max-w-[1280px] flex flex-col justify-center lg:flex-row gap-[30px]">
        ...
        <div
          className="
            ...
            p-[50px] shadow flex flex-col gap-[25px]
          "
        >
          <h2 className="text-[26px] font-semibold text-[#3C2B98]">
          ...
          <div className="border border-gray-300 rounded-[6px] p-4 flex gap-3">
            ...
            <p className="text-[14px] text-[#014648] leading-snug font-semibold">
            <a 
...
>
  ...
  anantapur.idn
          ...
          <div className="border border-gray-300 rounded-[6px] p-4 flex gap-3">
            ...
            <p className="text-[14px] text-[#014648] font-semibold">
          ...
          <iframe
            ...
            className="w-[450px] h-[318px] max-w-full"
        ...
        {/* RIGHT CARD — NOW WITH VALIDATION */}
        <form onSubmit={handleSubmit}>
          <div
            className="
              w-full lg:w-[550px]
              bg-white rounded-[8px]
              p-[50px] shadow flex flex-col gap-[20px]
            "
          >
            <h2 className="text-[26px] font-semibold text-[#3C2B98]">
            ...
            <p className="text-[18px] font-bold text-black">Get in Touch</p>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-full h-[44px] border border-gray-300 rounded-[6px] px-3 text-[14px]"
              />
              {errors.fullName && (
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className="w-full h-[44px] border border-gray-300 rounded-[6px] px-3 text-[14px] text-gray-600"
              >
            ...
            <div className="w-full flex justify-end">
              <button
                type="submit"
                className="
                  h-[40px] w-[110px] text-white text-[14px]
                  rounded-t-[12px] rounded-b-none transition-all duration-300
                "
                style={{
                  background:
                    "linear-gradient(90deg, #3C2B98 0%, #F5F5F5 110.56%)",
                }}
                onMouseEnter={(e) =>
